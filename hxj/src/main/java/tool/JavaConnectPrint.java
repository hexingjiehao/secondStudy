 ...
 * @program: hxj
 * @packageName: tool
 * @className JavaConnectPrint
 * @description: 连接打印机并打印文件
 * @author: xj
 * @create: 2020-08-26 17:18:23
 **/
public class JavaConnectPrint {

    public static void main(String[] args) {
        File file = new File("C:\\hydee\\workspace\\study-knowledgeBase\\hxj\\src\\main\\java\\tool\\git管理方案.jpg");
        String printerName = "Microsoft XPS Document Writer";//打印机名包含字串
        try {
